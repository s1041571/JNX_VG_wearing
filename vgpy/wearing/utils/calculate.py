...
# def get_bbox_to_fence_shortest_distance_and_point(box_middle_point, fence_points):
...
#     return bbox_to_fence_distances[0][0]*float(bili_data['bili']), bbox_to_fence_distances[0][1]
